...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .oauth2Login(config -> config
                        .userInfoEndpoint(this::userInfoEndpointConfigurer)
                )
    ...
    private void userInfoEndpointConfigurer(OAuth2LoginConfigurer.UserInfoEndpointConfig userInfoEndpointConfig) {
